...
- 审批来源可追踪：本人申报、单条代报、批量代报和定期生成都会保存工资所属人、创建人、提交人、批次及规则来源。管理员可审批全部待审记录；审核员只能审批指定给自己的记录（包括本人申报），最终付款前仍由人工核对。
...
管理员在“账号与权限 → 查看与审核配置”中选择账号，分别设置功能入口、完整资料授权和负责人对应审核员。功能开放、数据查看、审批与代报权限相互独立；授权撤销不需要重新登录。
