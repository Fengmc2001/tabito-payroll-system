...
管理员在“账号与权限 → 查看与审核配置”中选择账号，分别设置功能入口、完整资料与工资审批授权和负责人对应审核员。**自 2026-09-13 本次调整起，完整资料授权同时允许通过或驳回所选员工的全部待审工资，不受负责人和指定审核员限制，普通员工账号也适用。** 原有授权同样生效；工资审批入口自动开放。代报、转交审核、账号管理仍仅管理员可用。撤销授权不需要重新登录；若仍是某条工资的指定审核员，保留该条审批权。详见 [完整资料与审批授权说明](docs/approval-grants-2026-09-13.md)。
